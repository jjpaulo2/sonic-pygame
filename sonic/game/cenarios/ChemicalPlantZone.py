...
class ChemicalPlantZone:
    
    def __init__(self, tela):
        self.fundo_path = str(pathlib.Path(__file__).parent.absolute()) + "/../../img/cenarios/chemical-plant-pink-oceans.png"
        self.musica_path = str(pathlib.Path(__file__).parent.absolute()) + "/../../audio/chemical-plant-zone.wav"
        self.tela = tela
